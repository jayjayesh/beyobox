...
void main() {
  ...
  group('BeyoboxApiClient', () {
    late http.Client httpClient;
    late BeyoboxApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = BeyoboxApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => BeyoboxApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = BeyoboxApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws BeyoboxApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<BeyoboxApiMalformedResponse>()),
        );
      });

      test(
          'throws BeyoboxApiRequestFailure '
